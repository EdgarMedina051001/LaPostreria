...
import com.example.lapostreria.SplashScreenActivity
import com.example.lapostreria.databinding.FragmentPerfilBinding
    ...
    private fun subirDatosUsuarioFirebase(
        ...
        if (userId != null){
            ...
            usuarioRef.setValue(usuarioDatos).addOnSuccessListener {
                Toast.makeText(requireContext(), "Se actualizaron los datos correctamente.", Toast.LENGTH_SHORT).show()
            }.addOnFailureListener {
                Toast.makeText(requireContext(), "Error. No se actualizaron los datos.", Toast.LENGTH_SHORT).show()
            }
            ...
            usuarioRef.addListenerForSingleValueEvent(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    if (snapshot.exists()){
                        ...
                        val contrasenas = snapshot.child("password").getValue(String::class.java)?:""
